...
class SigLIPRetriever:
    """Retriever for Vanilla SigLIP-2 baseline"""
    ...
    def load_index(self):
        print(f"[*] Loading SigLIP-2 index from {self.index_dir}...")
        self.vector_store.load(self.index_dir, "siglip")

    def search(self, query_text: str, k: int = 5) -> list:
        """Searches the SigLIP-2 index using query text."""
